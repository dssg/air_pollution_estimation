...
from src.d00_utils.data_retrieval import retrieve_videos_s3_to_np, load_videos_from_local, retrieve_video_names_from_s3, append_to_csv,load_existing_video_names, download_video_and_convert_to_numpy,delete_and_recreate_dir
...
print("Retrieving video filenames")
selected_videos = retrieve_video_names_from_s3(
    paths, from_date='2019-06-30', to_date='2019-06-30',
    from_time='13-00-00', to_time='13-04-00',
    camera_list=params['tims_camera_list'],
    save_to_file=True)
# selected_videos = load_existing_video_names(paths)
print("Finished retrieving %s video filenames "%(len(selected_videos)))
