...
def download_detect_model_from_s3(model_name: str, paths: dict, s3_credentials: dict):
    ...
    if not os.path.exists(local_folder_path_model):
        ...
        files_to_download = dl.list_objects(
            prefix=paths["s3_detect_model"] + model_name
        )
        ...
        for path_of_file_to_download in files_to_download:
            ...
            dl.download_file(
                path_of_file_to_download=path_of_file_to_download,
