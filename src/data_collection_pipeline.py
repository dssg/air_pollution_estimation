...
from traffic_analysis.d01_data.collect_video_data import (
    download_camera_meta_data,
...
download_camera_meta_data(
    tfl_camera_api=tfl_camera_api, paths=paths, s3_credentials=s3_credentials
)
...
def upload_videos_fn():
    upload_videos(paths=paths, iterations=iterations, delay=delay)
