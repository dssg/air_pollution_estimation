...
def reload_kedro(line=None):
    ...
    try:
        ...
        from air_pollution_estimation.run import create_catalog, get_config

        proj_name = "air_pollution_estimation"
        ...
        if "create_catalog" in str(err):
            message = (
                ...
                "air_pollution_estimation/src/"
                "air_pollution_estimation/run.py."
